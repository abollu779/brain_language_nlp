...
n_folds = 4
n_epochs = 28
encoding_model_options = ['linear', 'linear_sgd_allvoxels', 'mlp_initial', 'mlp_smallerhiddensize', 'mlp_largerhiddensize', 'mlp_additionalhiddenlayer', 'mlp_allvoxels']
